...
class Help:
    def __init__(self, root):                                                                                                                
        ...
        title_lbl = Label(bg_lbl, text = "HELP", font=("Times New Roman", 20, "bold"), bg = "white", fg = "#bd0d2f")
        ...
        title_lb2 = Label(frame, text = "satianmol9@gmail.com", font=("Times New Roman", 20, "bold"), bg = "white", fg = "#4169e1")
        title_lb2.place(x= 1, y= 100, width= 570, height= 50)
        title_lb2 = Label(frame, text = "For any assistance or inquiries\nplease feel free to contact us\nat the email address provided above.", font=("Times New Roman", 16, "bold"), bg = "white", fg = "#bd0d2f")
        title_lb2.place(x= 1, y= 165, width= 570, height= 75)
